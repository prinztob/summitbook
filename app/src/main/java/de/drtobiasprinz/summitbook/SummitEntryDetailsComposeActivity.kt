...
fun SummitEntryDetailsTabs(
    ...
    Column(modifier = modifier.fillMaxSize()) {
        android.util.Log.i("SummitEntryDetails", "Rendering TabRow with ${tabs.size} tabs, current page: ${pagerState.currentPage}")
        TabRow(
        ...
        HorizontalPager(
            ...
            // Pass visibility state to child composables
            ...
            when (tabs[page]) {
                ...
                SummitTab.TRACK -> {
                    android.util.Log.i("SummitEntryDetails", "Rendering TRACK tab for page $page, visible: $isVisible")
                    if (isVisible) {
                        ...
                        // Show placeholder until tab becomes visible
                        Box(
                            modifier = Modifier.fillMaxSize(),
                            contentAlignment = Alignment.Center
                        ) {
