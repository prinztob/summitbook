...
class SortFilterHelper(
    private val filterAndSortView: View,
    private val context: Context,
    var entries: ArrayList<Summit>,
...
//    private val segmentedSortAscDesc: SegmentedButtonGroup =
//        filterAndSortView.findViewById(R.id.group_sort_asc_desc)
//    private val segmentedSortBy: SegmentedButtonGroup =
//        filterAndSortView.findViewById(R.id.group_sort_by)
//    private val segmentedWithPosition: SegmentedButtonGroup =
//        filterAndSortView.findViewById(R.id.group_position)
//    private val segmentedWithGpx: SegmentedButtonGroup =
//        filterAndSortView.findViewById(R.id.group_gpx)
//    private val segmentedWithImage: SegmentedButtonGroup =
//        filterAndSortView.findViewById(R.id.group_image)
//    private val segmentedMarkedSummit: SegmentedButtonGroup =
//        filterAndSortView.findViewById(R.id.group_favorite_peak_marker)
...
//        extremaValuesAllSummits?.minKilometers?.let {
//            multiSliderKilometers.setMin(
//                it.toInt(),
//                true,
//                true
//            )
//        }
//        extremaValuesAllSummits?.maxKilometersCeil?.let {
//            multiSliderKilometers.setMax(
//                it,
//                true,
//                true
//            )
...
//        extremaValuesAllSummits?.minHeightMeters?.let {
//            multiSliderHeightMeters.setMin(
//                it,
//                true,
//                true
//            )
//        }
//        extremaValuesAllSummits?.maxHeightMeters?.let {
//            multiSliderHeightMeters.setMax(
//                it,
//                true,
//                true
//            )
...
//        extremaValuesAllSummits?.minTopElevation?.let {
//            multiSliderTopElevation.setMin(
//                it,
//                true,
//                true
//            )
//        }
//        extremaValuesAllSummits?.maxTopElevation?.let {
//            multiSliderTopElevation.setMax(
//                it,
//                true,
//                true
//            )
...
//        extremaValuesAllSummits?.minTopSpeed?.let {
//            multiSliderTopSpeed.setMin(
//                it.toInt(),
//                true,
//                true
//            )
...
//        extremaValuesAllSummits?.minAverageSpeed?.let {
//            multiSliderAverageSpeed.setMin(
//                it.toInt(),
//                true,
//                true
//            )
//        }
//        extremaValuesAllSummits?.maxAverageSpeedCeil?.let {
//            multiSliderAverageSpeed.setMax(
//                it,
//                true,
//                true
//            )
...
//        val customDateLayout =
//            filterAndSortView.findViewById<LinearLayout>(R.id.date_start_end_selector)
...
//        val participantsView =
//            filterAndSortView.findViewById<AutoCompleteTextView>(R.id.autoCompleteTextViewParticipants)
...
////            extremaValuesAllSummits?.minAverageSpeed?.toInt()
////                ?: multiSliderAverageSpeed.getThumb(0).value
...
//        min1.text = String.format(
//            "%s km", (extremaValuesFilteredSummits?.minKilometers
//                ?: 0.0).toInt()
//        )
...
////                if (thumbIndex == 0) {
////                    min1.text =
////                        String.format("%s %s", value.toString(), context.getString(R.string.km))
...
////                if (thumbIndex == 0) {
////                    min1.text =
////                        String.format("%s %s", value.toString(), context.getString(R.string.hm))
...
//        min1.text = String.format(
//            "%s km/s", (extremaValuesFilteredSummits?.minTopSpeed
//                ?: 0.0).toInt()
//        )
...
////                if (thumbIndex == 0) {
////                    min1.text =
////                        String.format("%s %s", value.toString(), context.getString(R.string.kmh))
...
//        min1.text = String.format(
//            "%s km/s", (extremaValuesFilteredSummits?.minAverageSpeed
//                ?: 0.0).toInt()
//        )
...
//        overviewActivities.text = context.getString(
...
//        )
//        overviewSummits.text = context.getString(
//            R.string.base_info_summits,
//            peaks.size.toString(),
//            peaks.sumByDouble { it.kilometers }.toInt().toString(),
//            peaks.sumBy { it.elevationData.elevationGain }.toString()
//        )
//    }
//
//    private fun sort() {
...
//            when (position) {
//                0 -> {
//                    startDate = Summit.parseDate(
//                        String.format(
//                            "%s-01-01",
//                            if (uniqueYearsOfSummit.size == 0) "1900" else Collections.min(
//                                uniqueYearsOfSummit
//                            )
//                        )
//                    )
//                    endDate = Summit.parseDate(
//                        String.format(
//                            "%s-12-31",
//                            if (uniqueYearsOfSummit.size == 0) "2200" else Collections.max(
//                                uniqueYearsOfSummit
//                            )
//                        )
//                    )
...
//                            String.format(
//                                "%s-01-01",
//                                Collections.min(uniqueYearsOfSummit)
//                            )
//                        )
//                    }
...
////        overviewSummits = context.findViewById(R.id.overview_summits)
//        setOverviewText()
//    }
//
...
////        outState.putString(
////            SORT_FILTER_HELPER_MULTI_SLIDER_AVG_SPEED,
////            multiSliderToString(multiSliderAverageSpeed)
////        )
////        outState.putString(
////            SORT_FILTER_HELPER_MULTI_SLIDER_HEIGHT_METERS,
////            multiSliderToString(multiSliderHeightMeters)
////        )
////        outState.putString(
////            SORT_FILTER_HELPER_MULTI_SLIDER_KILOMETERS,
////            multiSliderToString(multiSliderKilometers)
////        )
////        outState.putString(
////            SORT_FILTER_HELPER_MULTI_SLIDER_TOP_ELEVATION,
////            multiSliderToString(multiSliderTopElevation)
////        )
////        outState.putString(
////            SORT_FILTER_HELPER_MULTI_SLIDER_TOP_SPEED,
////            multiSliderToString(multiSliderTopSpeed)
////        )
//    }
//
...
//            val filterAndSortView = factory.inflate(R.layout.fragment_sort_and_filter, null)
...
//                }
//                sortFilterHelper.setIndoorHeightMeterPercent(
...
//                val uniqueYears =
//                    savedInstanceState.getString(SORT_FILTER_HELPER_UNIQUE_YEARS)?.split(",")
//                        ?: emptyList()
...
//                sortFilterHelper.selectedSegmentedSortAscDesc =
//                    savedInstanceState.getInt(SORT_FILTER_HELPER_SELECTED_SORT_ASC_DESC)
//                sortFilterHelper.selectedSegmentedSortBy =
//                    savedInstanceState.getInt(SORT_FILTER_HELPER_SELECTED_SORT_BY)
//                sortFilterHelper.selectedSportTypeItem =
//                    savedInstanceState.getInt(SORT_FILTER_HELPER_SELECTED_SPORT_TYPE)
//                sortFilterHelper.selectedSegmentedWithPosition =
//                    savedInstanceState.getInt(SORT_FILTER_HELPER_POSITION_SELECTED)
//                sortFilterHelper.selectedSegmentedWithGpx =
//                    savedInstanceState.getInt(SORT_FILTER_HELPER_GPX_SELECTED)
//                sortFilterHelper.selectedSegmentedWithImage =
//                    savedInstanceState.getInt(SORT_FILTER_HELPER_IMAGE_SELECTED)
//                sortFilterHelper.selectedSegmentedMarkedSummit =
//                    savedInstanceState.getInt(SORT_FILTER_HELPER_MARKED_SUMMIT)
////                setMultiSlider(
////                    savedInstanceState,
////                    sortFilterHelper.multiSliderAverageSpeed,
////                    SORT_FILTER_HELPER_MULTI_SLIDER_AVG_SPEED
////                )
////                setMultiSlider(
////                    savedInstanceState,
////                    sortFilterHelper.multiSliderTopSpeed,
////                    SORT_FILTER_HELPER_MULTI_SLIDER_TOP_SPEED
////                )
////                setMultiSlider(
////                    savedInstanceState,
////                    sortFilterHelper.multiSliderHeightMeters,
////                    SORT_FILTER_HELPER_MULTI_SLIDER_HEIGHT_METERS
////                )
////                setMultiSlider(
////                    savedInstanceState,
////                    sortFilterHelper.multiSliderKilometers,
////                    SORT_FILTER_HELPER_MULTI_SLIDER_KILOMETERS
////                )
////                setMultiSlider(
////                    savedInstanceState,
////                    sortFilterHelper.multiSliderTopElevation,
////                    SORT_FILTER_HELPER_MULTI_SLIDER_TOP_ELEVATION
////                )
...
//        }
//
////        private fun setMultiSlider(
////            savedInstanceState: Bundle,
////            multiSlider: MultiSlider,
////            multiSliderKey: String
////        ) {
...
//        var SORT_FILTER_HELPER_MULTI_SLIDER_HEIGHT_METERS =
//            "SORT_FILTER_HELPER_MULTI_SLIDER_HEIGHT_METERS"
//        var SORT_FILTER_HELPER_MULTI_SLIDER_KILOMETERS =
//            "SORT_FILTER_HELPER_MULTI_SLIDER_KILOMETERS"
//        var SORT_FILTER_HELPER_MULTI_SLIDER_TOP_ELEVATION =
//            "SORT_FILTER_HELPER_MULTI_SLIDER_TOP_ELEVATION"
//
//    }
}