...
@AndroidEntryPoint
class LineChartFragmentCompose : Fragment() {
                    ...
                    Surface(
                        ...
                        LineChartScreen(
                            ...
                            onNavigateToSummitDetails = { summitId ->
                                val intent = Intent(requireContext(), SummitEntryDetailsComposeActivity::class.java)
                                intent.putExtra(Constants.SUMMIT_ID_EXTRA_IDENTIFIER, summitId)
