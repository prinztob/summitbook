...
import de.drtobiasprinz.summitbook.widget.theme.GlanceColorScheme
...
interface WidgetRepositoryEntryPoint {
    fun repository(): DatabaseRepository
}
...
class SummitBookGlanceWidget : GlanceAppWidget() {
    ...
    private data class ChartData(
        val actualEntries: List<de.drtobiasprinz.summitbook.data.model.ChartEntry>,
        val forecastEntries: List<de.drtobiasprinz.summitbook.data.model.ChartEntry>,
        val minEntries: List<de.drtobiasprinz.summitbook.data.model.ChartEntry>,
        val maxEntries: List<de.drtobiasprinz.summitbook.data.model.ChartEntry>
    )
    ...
    private fun drawMinMaxArea(
        canvas: Canvas,
        minEntries: List<de.drtobiasprinz.summitbook.data.model.ChartEntry>,
        maxEntries: List<de.drtobiasprinz.summitbook.data.model.ChartEntry>,
        bounds: ChartBounds,
        chartWidth: Float,
        chartHeight: Float,
        padding: Float = 20f
    ...
    private fun drawActualDataLine(
        canvas: Canvas,
        actualEntries: List<de.drtobiasprinz.summitbook.data.model.ChartEntry>,
        maxEntries: List<de.drtobiasprinz.summitbook.data.model.ChartEntry>,
        forecastEntries: List<de.drtobiasprinz.summitbook.data.model.ChartEntry>,
        bounds: ChartBounds,
        chartWidth: Float,
        chartHeight: Float,
        padding: Float = 20f
    ...
    private fun determineLineColor(
        entry: de.drtobiasprinz.summitbook.data.model.ChartEntry,
        maxEntries: List<de.drtobiasprinz.summitbook.data.model.ChartEntry>,
        forecastEntries: List<de.drtobiasprinz.summitbook.data.model.ChartEntry>
    ): Int {
    ...
    private fun createWidgetDataFromForecasts(
        ...
        val actualHeightMeterMonthly = summitsForCurrentMonth.sumOf {
            if (it.sportType == de.drtobiasprinz.summitbook.data.db.entities.SportType.IndoorTrainer) {
