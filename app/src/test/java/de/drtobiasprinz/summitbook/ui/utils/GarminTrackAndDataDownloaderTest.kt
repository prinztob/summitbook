...
class GarminTrackAndDataDownloaderTest {
    ...
    fun testExtractFinalSummitWithouGarmin() {
        val entry1 = Summit(Summit.parseDate("2019-11-13"), "summit1", SportType.Bicycle, listOf("place1"), listOf("country1"), "comment1", ElevationData.Companion.parse(11, 1), 1.0, VelocityData.Companion.parse(1.0, 11.3),  0.0,0.0, mutableListOf("participant1"), false, mutableListOf(), null, null)
    ...
    fun testExtractFinalSummitWithSeveralGarminActivities() {
        ...
        val entry1 = Summit(Summit.parseDate("2019-11-13"), "summit1", SportType.Bicycle, listOf("place1"), listOf("country1"), "comment1", ElevationData.Companion.parse(1, 11), 1.0, VelocityData.Companion.parse(1.0, 11.3),  0.0,0.0,mutableListOf("participant1"), false, mutableListOf(), null, null)
        ...
        val entry2 = Summit(Summit.parseDate("2019-11-13"), "summit2", SportType.Bicycle, listOf("place2"), listOf("country2"), "comment2", ElevationData.Companion.parse(10, 110), 10.0, VelocityData.Companion.parse(5.0, 12.3),  0.0,0.0,mutableListOf("participant2"), false, mutableListOf(), null, null)
        ...
        val entry3 = Summit(Summit.parseDate("2019-11-13"), "summit3", SportType.Bicycle, listOf("place3"), listOf("country3"), "comment3", ElevationData.Companion.parse(100, 1100), 70.0, VelocityData.Companion.parse(10.0, 10.3),  0.0,0.0,mutableListOf("participant4"), false, mutableListOf(), null, null)
