...
class GarminTrackAndDataDownloaderTest {
    ...
    fun testExtractFinalSummitEntryWithouGarmin() {
        val entry1 = SummitEntry(SummitEntry.parseDate("2019-11-13"), "summit1", SportType.Bicycle, listOf("place1"), listOf("country1"), "comment1", 1, 1.0, VelocityData.Companion.parse(1.0, 11.3), 11, mutableListOf("participant1"), mutableListOf())
        val entry2 = SummitEntry(SummitEntry.parseDate("2019-11-13"), "summit2", SportType.Bicycle, listOf("place2"), listOf("country2"), "comment2", 10, 10.0, VelocityData.Companion.parse(5.0, 12.3), 110, mutableListOf("participant2"), mutableListOf())
        val entry3 = SummitEntry(SummitEntry.parseDate("2019-11-13"), "summit3", SportType.Bicycle, listOf("place3"), listOf("country3"), "comment3", 100, 70.0, VelocityData.Companion.parse(10.0, 10.3), 1100, mutableListOf("participant4"), mutableListOf())
        val finalEntryExpected = SummitEntry(SummitEntry.parseDate("2019-11-13"), "summit1", SportType.Bicycle, listOf("place1"), listOf("country1"), "merge of summit1, summit2, summit3", 111, 81.0, VelocityData.Companion.parse(8.1, 12.3), 1100, mutableListOf("participant1"), mutableListOf())
